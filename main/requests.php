...
<html lang="en">
    ...
    <body>
        ...
        <script src="js/modalDemo.js" type="text/javascript"></script>
        <script src="../js/load_join_request.js" type="text/javascript"></script>
            ...
            <div class="container-fluid page-body-wrapper">
                <div class="row row-offcanvas row-offcanvas-right">
                    ...
                    <div class="content-wrapper">
                        <h3 class="page-title">Join Requests</h3>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Manage Join Request</h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <table id="user_edit_table">
                                        ...
                                        <tr class="user_row">
                                            <td class="user_row label_modal">Password</td>
                                            <td class="user_row"><input type="password" name="" id="user_password"></td>
                                        </tr>
                                        ...
                                        <tr class="user_row">
                                            ...
                                            <td class="user_row"><input type="text" name="" id="user_role" required=""></td>
                                        </tr>
                                        <tr >
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" id="save_add_user" class="btn btn-primary">Accept</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Mirrored from www.urbanui.com/titan/pages/tables/js-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 Oct 2017 13:45:16 GMT -->
</html>
