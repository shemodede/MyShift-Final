...
if (isset($_POST['full_hours_array'])) {
    ...
    $result = '<table><tr><th style="width: 2%">Name</th><th style="width: 2%">Hours</th><th style="width: 2%">'
            . 'Total'
            . '</th>'
            . '</tr>';
    ...
    echo json_encode(array('fulltext' => $result, 'total_hours' => $total_hours, 'total_expense' => '<strong>Grand Total: </strong>R'.$total_expenses));
} else {
