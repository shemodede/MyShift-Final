...
if (isset($_POST['full_hours_array'])) {
    ...
    $save_full_hours = "UPDATE compiled_list SET full_hours_in_week = '$full_hours_json' WHERE company_id = '$company_id' AND id = (SELECT max(id) FROM compiled_list)";
    $save_full_hours_result = mysqli_query($db, $save_full_hours);
