(function ($) {
    ...
    form.children("div").steps({
        ...
        onStepChanging: function (event, currentIndex, newIndex) {
            if (currentIndex === 0) {
                shift_week = $('#shift_week_select').val();
                shift_date = $('#shift_date_select').val();
            ...
            if ($('#shift_party_1_select').val() === "blank" && $('#shift_party_2_select').val() === "blank" && $('#shift_party_1_select').val() !== $('#shift_party_2_select').val()) {
                ...
                $('#party_1_user_name').text(getShiftSwapPartyUser(party_1_id));
                $('#party_2_user_name').text(getShiftSwapPartyUser(party_2_id));
